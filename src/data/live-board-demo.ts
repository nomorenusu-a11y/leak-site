...
export type DemoRequest = {
  ...
  masked_name: string;
  /** "서울 강남구" / "경기 성남시" / "강원 춘천시" 등 */
  region: string;
  /** 광역 단위 (지역 다양성 검사용). */
  metro: "서울" | "경기" | "인천" | "강원" | "충청";
...
export const DEMO_POOL: readonly DemoRequest[] = [
  ...
  { id: "d010", masked_name: "임o호", region: "경기 분당구",  metro: "경기", category: "sink",    symptom: "주방 배수 역류" },
  ...
  { id: "d014", masked_name: "안o석", region: "경기 일산구",  metro: "경기", category: "leak",    symptom: "천장 얼룩 + 물방울" },
  ...
  // === 강원 3건 ===
  { id: "d021", masked_name: "오o연", region: "강원 춘천시",  metro: "강원", category: "frozen",  symptom: "수도 동파" },
  { id: "d022", masked_name: "류o석", region: "강원 원주시",  metro: "강원", category: "heating", symptom: "보일러 동결" },
  { id: "d023", masked_name: "도o윤", region: "강원 강릉시",  metro: "강원", category: "leak",    symptom: "지하실 침수" },

  // === 충청 3건 ===
  { id: "d024", masked_name: "양o지", region: "충남 천안시",  metro: "충청", category: "leak",    symptom: "방수층 손상" },
  { id: "d025", masked_name: "차o호", region: "충북 청주시",  metro: "충청", category: "toilet",  symptom: "정화조 역류" },
  { id: "d026", masked_name: "표o윤", region: "세종특별자치시", metro: "충청", category: "heating", symptom: "온수기 누수" },
