...
const publicSchema = z.object({
  ...
  NEXT_PUBLIC_BUSINESS_LEGAL_NAME: optionalString,
  ...
  NEXT_PUBLIC_BUSINESS_BIZ_TYPE: optionalString,
  NEXT_PUBLIC_BUSINESS_BIZ_CATEGORY: optionalString,
...
function readPublicEnv() {
  return {
    ...
    NEXT_PUBLIC_BUSINESS_LEGAL_NAME: process.env.NEXT_PUBLIC_BUSINESS_LEGAL_NAME,
    ...
    NEXT_PUBLIC_BUSINESS_BIZ_TYPE: process.env.NEXT_PUBLIC_BUSINESS_BIZ_TYPE,
    NEXT_PUBLIC_BUSINESS_BIZ_CATEGORY: process.env.NEXT_PUBLIC_BUSINESS_BIZ_CATEGORY,
