...
const LEAK_TYPES: LeakType[] = [
  {
    ...
    value: "수도배관 누수",
    slug: "water-pipe",
    clue: "계량기 움직임과 급수 배관의 압력 변화를 함께 확인합니다.",
  },
  {
    group: "급수·온수·난방 배관",
    value: "온수배관 누수",
    slug: "hot-water-pipe",
    clue: "온수를 사용할 때 변화가 생기는지와 온수 배관의 압력 상태를 구분해 봅니다.",
  },
  {
    group: "급수·온수·난방 배관",
    value: "난방배관 누수",
    slug: "heating-pipe",
    clue: "보일러 압력 저하 여부와 난방 배관 계통의 상태를 우선 확인합니다.",
  },
  {
    group: "급수·온수·난방 배관",
    value: "직수관 누수",
    slug: "direct-water-pipe",
    clue: "물을 사용하지 않는 시간에도 계량기 변화가 있는지 확인하는 것이 출발점입니다.",
  },
  {
    group: "급수·온수·난방 배관",
    value: "매립배관 누수",
    slug: "buried-pipe",
    clue: "보이는 물기만으로 굴착 범위를 정하지 않고 배관 경로와 반응을 함께 살핍니다.",
  },
  {
    group: "급수·온수·난방 배관",
    value: "급수배관 누수",
    slug: "supply-pipe",
    clue: "사용 조건과 압력 변화를 비교해 어느 배관 계통인지 좁혀 갑니다.",
  },
  {
    group: "보일러·계량기 설비",
    value: "보일러 누수",
    slug: "boiler",
    clue: "보일러 본체·연결부·압력계 변화를 나누어 확인합니다.",
  },
  {
    group: "보일러·계량기 설비",
    value: "보일러 배관 누수",
    slug: "boiler-pipe",
    clue: "보일러 주변 물기와 난방 계통의 압력 변화를 함께 점검합니다.",
  },
  {
    group: "보일러·계량기 설비",
    value: "분배기 누수",
    slug: "manifold",
    clue: "분배기 연결부와 밸브 주변의 물기, 배관 계통별 반응을 확인합니다.",
  },
  {
    group: "보일러·계량기 설비",
    value: "수도계량기 누수",
    slug: "water-meter",
    clue: "계량기함 내부와 연결 밸브에서 새는지, 배관 누수 신호인지 구분합니다.",
  },
  {
    group: "보일러·계량기 설비",
    value: "계량기 밸브 누수",
    slug: "meter-valve",
    clue: "밸브 패킹·연결부의 물기와 계량기 회전 상태를 함께 살핍니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "화장실 누수",
    slug: "toilet-room",
    clue: "급수·배수·방수층 가운데 어떤 조건에서 물이 나타나는지 구분합니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "욕실 누수",
    slug: "bathroom",
    clue: "샤워 사용, 바닥 배수, 벽체와 배관 주변을 나누어 점검합니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "변기 누수",
    slug: "toilet-fixture",
    clue: "변기 급수 연결부·배수 연결부·바닥 밀착부의 상태를 구분해 봅니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "세면대 누수",
    slug: "sink-fixture",
    clue: "수전, 배수 트랩, 벽체 연결부 중 물이 생기는 조건을 확인합니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "샤워부스 누수",
    slug: "shower-booth",
    clue: "사용 중 누수인지, 실리콘·문틀·배수 문제인지 분리해 확인합니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "싱크대 누수",
    slug: "kitchen-sink",
    clue: "급수 호스, 배수관, 싱크볼 주변과 하부장 내부 상태를 살핍니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "주방 배수관 누수",
    slug: "kitchen-drain",
    clue: "물을 흘려보낼 때만 생기는지와 배수 연결부 상태를 확인합니다.",
  },
  {
    group: "욕실·주방·배수",
    value: "하수관 누수",
    slug: "drain-pipe",
    clue: "배수 사용 조건, 악취, 역류 여부를 기준으로 배수 계통을 점검합니다.",
  },
  {
    group: "건물 부위·외부 유입",
    value: "천장 누수",
    slug: "ceiling",
    clue: "물자국 위치가 곧 원인 위치는 아니므로 위층 설비·배관 경로를 함께 확인합니다.",
  },
  {
    group: "건물 부위·외부 유입",
    value: "베란다 누수",
    slug: "veranda",
    clue: "배수구·창호·외벽·방수층 가운데 비나 사용 조건과 관계있는지 확인합니다.",
  },
  {
    group: "건물 부위·외부 유입",
    value: "외벽 누수",
    slug: "exterior-wall",
    clue: "강우 시점과 균열·코킹·창호 주변 상태를 함께 살핍니다.",
  },
  {
    group: "건물 부위·외부 유입",
    value: "옥상 누수",
    slug: "rooftop",
    clue: "방수층·배수·파라펫 주변을 점검해 유입 경로를 구분합니다.",
  },
  {
    group: "건물 부위·외부 유입",
    value: "창틀 누수",
    slug: "window-frame",
    clue: "창틀 코킹, 배수홀, 외벽 접합부와 강우 시점을 함께 확인합니다.",
  },
];
...
type DraftInput = {
  ...
  mode: DraftMode;
  guideType: ScheduledContentType;
  caseMemo: string;
  imageCount: number;
};
...
const TOPIC_RECIPES: TopicRecommendation[] = [
  {
    building: "아파트",
    damageLocation: "아랫집 천장",
    leakSlug: "hot-water-pipe",
    symptom: "보일러 압력이 계속 떨어짐",
    method: "계량기·압력 검사",
    workDirection: "배관 부분 굴착·보수 여부 안내",
  },
  {
    building: "빌라",
    damageLocation: "욕실 바닥·벽체",
    leakSlug: "toilet-fixture",
    symptom: "변기 주변 바닥이 젖음",
    method: "배수·통수 검사",
    workDirection: "배수·방수 보수 여부 안내",
  },
  {
    building: "오피스텔",
    damageLocation: "주방 싱크대 주변",
    leakSlug: "kitchen-sink",
    symptom: "벽지나 벽면이 젖음",
    method: "육안·수분 상태 점검",
    workDirection: "밸브·연결부 보수 여부 안내",
  },
  {
    building: "다세대·다가구",
    damageLocation: "계량기함·공용부",
    leakSlug: "water-meter",
    symptom: "계량기가 계속 돌아감",
    method: "계량기·압력 검사",
    workDirection: "밸브·연결부 보수 여부 안내",
  },
  {
    building: "아파트",
    damageLocation: "보일러실·다용도실",
    leakSlug: "manifold",
    symptom: "보일러 보충수가 자주 필요함",
    method: "계량기·압력 검사",
    workDirection: "밸브·연결부 보수 여부 안내",
  },
  {
    building: "단독주택",
    damageLocation: "베란다·창틀 주변",
    leakSlug: "window-frame",
    symptom: "곰팡이와 습기가 심해짐",
    method: "육안·수분 상태 점검",
    workDirection: "배수·방수 보수 여부 안내",
  },
  {
    building: "아파트",
    damageLocation: "거실·방 바닥",
    leakSlug: "heating-pipe",
    symptom: "장판이나 마루가 들뜸",
    method: "가스탐지",
    workDirection: "배관 부분 굴착·보수 여부 안내",
  },
  {
    ...
    symptom: "천장에서 물이 떨어짐",
    method: "열화상 점검",
    workDirection: "원인 확인 후 부분 보수 여부 안내",
  },
  {
    building: "빌라",
    damageLocation: "욕실 바닥·벽체",
    leakSlug: "bathroom",
    symptom: "욕실 바닥 물고임이 계속됨",
    method: "배수·통수 검사",
    workDirection: "배수·방수 보수 여부 안내",
  },
  {
...
function leakTerms(leak: LeakType) {
  ...
  if (leak.value.includes("싱크대") || leak.value.includes("주방"))
    return ["싱크대", "배수관", "주방 배수관"];
...
function scoreAsset(
  asset: AnalyzedMediaAsset,
  input: Pick<DraftInput, "leak" | "symptom" | "damageLocation" | "method" | "workDirection">,
) {
  ...
  if (
    ["열화상 점검", "가스탐지", "청음탐지", "계량기·압력 검사"].includes(input.method) &&
    (analysis.work_stage === "detection" || analysis.visible_subject_tags.includes("탐지장비"))
  )
    score += 4;
  if (
    input.workDirection.includes("보수") &&
    (analysis.work_stage === "repair" || analysis.visible_subject_tags.includes("보수공구"))
  )
    score += 3;
  return score;
}

function pickMatchedAssets(
  assets: AnalyzedMediaAsset[],
  input: Pick<DraftInput, "leak" | "symptom" | "damageLocation" | "method" | "workDirection">,
) {
  const ranked = assets
...
function guideFocusBlock(input: DraftInput) {
  const { place, building, leak, symptom, damageLocation, guideType } = input;
  const blocks: Record<ScheduledContentType, string> = {
    region_overview: `## ${place} 누수, 건물 조건부터 확인합니다

${place} ${building}에서는 전용·공용 배관의 경계와 물 사용 조건을 함께 살펴야 합니다. 같은 물자국도 급수, 배수, 방수, 외부 유입에 따라 점검 순서가 달라집니다.`,
    symptom_solution: `## ${symptom}, 원인을 나누는 기준

물을 사용하지 않을 때도 계속되는지, 온수·난방·배수 중 언제 심해지는지, 비가 온 날과 관계있는지를 먼저 비교합니다. ${damageLocation}의 흔적만으로 ${leak.value}를 단정하지 않습니다.`,
    self_check: `## 도구 없이 하는 5분 자가점검

1. 물을 사용하는 설비를 모두 멈춥니다.
2. 계량기나 보일러 압력계를 촬영합니다.
3. 5분 뒤 같은 각도에서 다시 촬영합니다.
4. 젖은 경계와 발생 시간을 기록합니다.

자가점검은 직접 수리하기 위한 과정이 아니라 전문가에게 정확한 단서를 전달하기 위한 준비입니다.`,
    cost_insurance: `## 비용과 보험을 확인하기 전에

비용은 탐지 검사, 손상 위치, 철거 범위, 배관 자재, 마감 복구에 따라 달라집니다. 점검비·보수비·복구비를 구분하고 보험사에는 계약별 보장 항목과 필요한 서류를 먼저 확인하세요.`,
    emergency: `## 첫 10분, 추가 피해부터 막습니다

수도·보일러·세탁기 사용을 멈추고 물이 번지는 방향을 촬영하세요. 아래층 피해가 있다면 즉시 알리고, 전기 설비 주변이 젖었다면 해당 공간 사용을 중단해야 합니다.`,
  };
  return blocks[guideType];
}
...
function buildDraft(input: DraftInput, district: Region, dong?: Region): Draft {
  ...
  const property = normalizedBuildingName
    ? normalizedBuildingName.endsWith(building)
  ...
  const guideTitles: Record<ScheduledContentType, string> = {
    region_overview: `${place} 누수탐지 | ${property}에서 자주 확인하는 ${leak.value}`,
    symptom_solution: `${place} ${leak.value} | ${symptom} 원인 구분`,
    self_check: `${place} ${leak.value} 자가점검 | ${symptom} 확인 순서`,
    cost_insurance: `${place} ${leak.value} 비용·보험 | 점검 전 준비사항`,
    emergency: `${place} ${leak.value} 긴급대응 | ${symptom} 때 먼저 할 일`,
  };
  const title =
    mode === "case"
      ? `${place} 누수탐지 | ${buildingName ? `${buildingName} ` : ""}${leak.value} ${symptom} 점검·보수 사례`
      : guideTitles[guideType];
  const marker = mode === "case" ? "verified_case" : guideType;
  const focusBlock =
    mode === "case"
      ? `## 확인된 현장 기록\n\n${caseMemo.trim()}\n\n현장 조건과 확인 결과를 기준으로 점검·보수 과정을 정리했습니다.`
      : guideFocusBlock(input);
  return {
    title,
    excerpt:
      mode === "case"
        ? `${subject}의 확인된 현장 기록을 바탕으로 ${leak.value} 점검과 보수 과정을 정리했습니다.`
        : `${subject}에서 ${symptom}이 보일 때 ${leak.value} 가능성을 구분하는 기준과 준비사항을 안내합니다.`,
    imageStages: stages,
    content: `<!-- content-type:${marker} -->

${focusBlock}

## ${place} ${property} ${leak.value} 점검
...
function isSimilarTitle(title: string, existingTitles: string[]) {
  ...
  return existingTitles.some((existing) => {
    ...
    return (
      ...
      (candidate.length > 14 && (candidate.includes(normalized) || normalized.includes(candidate)))
    );
  });
}
...
export function AutoPostComposer({ assets, existingTitles }: Props) {
  ...
  const [guideType, setGuideType] = useState<ScheduledContentType>("symptom_solution");
  const [caseMemo, setCaseMemo] = useState("");
  const [recommendations, setRecommendations] = useState<TopicRecommendation[]>(() =>
    randomPick(TOPIC_RECIPES, 6),
  );
  ...
  function generate() {
    setError(null);
    if (!district) {
      setError("구를 먼저 선택해 주세요.");
      return;
    }
    if (mode === "case" && caseMemo.trim().length < 20) {
      setError("사례형 글은 확인된 현장 메모를 20자 이상 입력해 주세요.");
      return;
    }
    const nextPicked = pickMatchedAssets(assets, {
      leak,
      symptom,
      damageLocation,
      method,
      ...
      try {
        ...
        for (let index = 0; index < picked.length; index += 1) {
          const attached = await attachMediaAssetToPost({
            ...
            altText: `${leak.value} 점검 안내 사진 — ${draft.imageStages[index]}`,
            caption: `${leak.value} 점검 안내를 위한 참고 사진입니다. 사진에 보이는 범위는 실제 현장 확인 뒤 안내합니다.`,
          });
        ...
        const content = draft.content.replace(/\[\[AUTO_IMAGE_(\d+)\]\]/g, (_, raw) =>
          imageIds[Number(raw)] ? `[[post-image:${imageIds[Number(raw)]}]]` : "",
        );
        ...
        router.push(published ? `/posts/${created.slug}` : `/admin/posts/${created.postId}/edit`);
        router.refresh();
      } catch {
        setError(
  ...
  return (
    <div className="grid gap-8 lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)]">
      <div className="space-y-5">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm font-extrabold text-slate-900">오늘의 글 주제 추천</p>
              <p className="mt-1 text-xs leading-5 text-slate-500">
                서로 다른 건물·증상·누수 유형을 섞어 제안합니다.
              </p>
            </div>
            <button
              type="button"
              onClick={() => setRecommendations(randomPick(TOPIC_RECIPES, 6))}
          ...
          <div className="mt-3 grid gap-2">
            {recommendations.map((topic, index) => {
              const topicLeak = LEAK_TYPES.find((item) => item.slug === topic.leakSlug);
              return (
                <button
                  key={`${topic.leakSlug}-${topic.symptom}-${index}`}
                  type="button"
                  onClick={() => applyRecommendation(topic)}
                  className="hover:border-brand-400 hover:bg-brand-50 rounded-lg border border-slate-200 p-3 text-left text-sm transition"
                >
                  <span className="font-bold text-slate-900">
                    {place} {topic.building} {topicLeak?.value}
                  </span>
                  <span className="mt-1 block text-xs text-slate-600">
                    {topic.damageLocation} · {topic.symptom}
                  </span>
                </button>
              );
            })}
          ...
          <p className="mt-3 text-xs leading-5 text-slate-500">
            선택하면 아래 입력값이 자동으로 채워집니다. 실제 사례로 공개할 때는 현장 메모와 사진을
            확인해 사례형으로 전환합니다.
          </p>
        </div>
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
          <p className="text-sm font-extrabold text-slate-900">오늘의 작성 흐름</p>
          <ol className="mt-2 grid gap-1 text-xs leading-5 text-slate-700">
            <li>
              <strong>1.</strong> 지역과 누수 상황을 선택
            </li>
            <li>
              <strong>2.</strong> 자동 초안과 선택 사진을 확인
            </li>
            <li>
              <strong>3.</strong> 실제 사례면 현장 메모를 넣고, 아니면 점검 안내로 유지
            </li>
            <li>
              <strong>4.</strong> 임시저장 후 편집하거나 바로 공개
            </li>
          </ol>
        </div>
        <div className="border-brand-100 bg-brand-50 rounded-xl border p-4">
          <p className="text-sm font-extrabold text-slate-900">글 작성 기준</p>
          <div className="mt-3 grid gap-2 text-sm text-slate-700">
            <label>
              <input type="radio" checked={mode === "guide"} onChange={() => setMode("guide")} />{" "}
              <span className="ml-2 font-bold">점검·상담 안내</span>
              <span className="ml-1 text-slate-500">확인 전 정보 중심</span>
            </label>
            <label>
              <input type="radio" checked={mode === "case"} onChange={() => setMode("case")} />{" "}
              <span className="ml-2 font-bold">실제 시공사례</span>
              <span className="ml-1 text-slate-500">확인 메모 필수</span>
            </label>
          </div>
          {mode === "case" && (
            <textarea
              value={caseMemo}
              onChange={(event) => setCaseMemo(event.target.value)}
              placeholder="예: 아랫집 주방 천장 물자국 확인, 온수관 압력 저하 확인, 부분 굴착 후 배관 보수"
              className="mt-3 min-h-24 w-full rounded-lg border border-slate-300 p-3 text-sm font-normal"
            />
          )}
          {mode === "guide" && (
            <label className="mt-4 grid gap-2 text-sm font-bold text-slate-800">
              ...
              <select
                value={guideType}
                onChange={(event) => setGuideType(event.target.value as ScheduledContentType)}
                className={selectClass}
              >
                {Object.entries(SCHEDULED_CONTENT_TYPE_LABELS).map(([value, label]) => (
              ...
              <span className="text-xs leading-5 font-normal text-slate-500">
                같은 지역과 증상이라도 검색 목적에 맞춰 제목과 첫 문단을 다르게 작성합니다.
              </span>
            </label>
          )}
        </div>
        ...
        <label className="grid gap-2 text-sm font-bold text-slate-800">
          건물명 <span className="font-normal text-slate-500">(선택)</span>
          <input
            value={buildingName}
            maxLength={60}
        ...
        <label className="grid gap-2 text-sm font-bold text-slate-800">
          ...
          <select
            value={workDirection}
            onChange={(event) => setWorkDirection(event.target.value)}
            className={selectClass}
          >
        ...
        <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4 text-sm leading-6 text-slate-700">
          <p className="font-bold text-slate-800">AI 사진 자동 선택</p>
          <p className="mt-1">
            누수 유형·피해 위치·증상·탐지 단계와 맞는 <strong>태그 완료 사진</strong>만 우선
            고릅니다. 내용이 모호한 사진은 자동 선택에서 제외합니다.
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
        {draft ? (
          <>
            <p className="text-brand-700 text-xs font-bold tracking-wider">
              네이버 자연검색용 초안 미리보기
            </p>
            <span className="mt-3 inline-flex rounded-full bg-blue-100 px-2.5 py-1 text-xs font-bold text-blue-700">
              {mode === "case" ? "실제 사례" : SCHEDULED_CONTENT_TYPE_LABELS[guideType]}
            </span>
            ...
            {duplicateWarning && (
              <p className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm font-semibold text-amber-800">
                비슷한 제목의 기존 글이 있습니다. 지역·건물명·증상 또는 누수 유형을 바꾼 뒤 저장해
                주세요.
              </p>
            )}
            {qualityWarning && (
            ...
            <p className="mt-5 rounded-lg bg-white p-3 text-sm font-semibold text-slate-700">
              선택 사진: {picked.length}장 · 저장 시 글 속 사진 위치와 ALT·캡션이 등록됩니다.
            </p>
            ...
            <div className="mt-5 grid gap-2 sm:grid-cols-2">
              <button
                type="button"
                disabled={pending || duplicateWarning || qualityWarning}
                onClick={() => saveDraft(false)}
                className="rounded-lg bg-slate-900 px-4 py-3 font-bold text-white disabled:bg-slate-400"
              >
                {pending ? "저장 중..." : "임시저장하고 편집하기"}
              </button>
              <button
                type="button"
                disabled={pending || duplicateWarning || qualityWarning}
                onClick={() => saveDraft(true)}
                className="bg-brand-600 rounded-lg px-4 py-3 font-bold text-white disabled:bg-slate-400"
              >
                {pending ? "발행 중..." : "공개 발행하기"}
              </button>
            </div>
            <p className="mt-2 text-xs leading-5 text-slate-500">
              공개 발행하면 해당 글은 사이트맵에 반영됩니다. 실제 사례형은 현장 메모와 사진을 확인한
              뒤 발행하세요.
            </p>
          </>
        ) : (
          <p className="text-sm leading-6 text-slate-500">
            왼쪽에서 지역·건물·증상·누수 유형을 고르면, 모바일 자연검색에서 읽히는 제목과 글·사진
            흐름의 초안을 만듭니다. 먼저 임시저장으로 검토하세요.
          </p>
        )}
      </div>
    </div>
