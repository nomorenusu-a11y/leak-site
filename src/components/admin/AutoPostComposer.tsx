...
export function AutoPostComposer({ assets, existingTitles }: Props) {
  ...
  return <div className="grid gap-8 lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)]"><div className="space-y-5">
    ...
    <div className="rounded-xl border border-blue-200 bg-blue-50 p-4"><p className="text-sm font-extrabold text-slate-900">오늘의 작성 흐름</p><ol className="mt-2 grid gap-1 text-xs leading-5 text-slate-700"><li><strong>1.</strong> 지역과 누수 상황을 선택</li><li><strong>2.</strong> 자동 초안과 선택 사진을 확인</li><li><strong>3.</strong> 실제 사례면 현장 메모를 넣고, 아니면 점검 안내로 유지</li><li><strong>4.</strong> 임시저장 후 편집하거나 바로 공개</li></ol></div>
